...
from Vacunation_app.views.homes.vaccinator_home_view import HomeView, contact_view, logout_view, notification_view, zona_view
...
urlpatterns = [
    ...
    path("administrator/",include("Vacunation_app.urls.administrator_urls"),name="admin_home_view"),
    path("vaccinator/",include("Vacunation_app.urls.vaccinator_urls"),name="vaccinator_home_view"),
    path("patient/",include("Vacunation_app.urls.patient_urls"),name="patient_home_view"),
