...
from Vacunation_app.views.administrator.patient_list_view import patient_profile_view
...
from Vacunation_app.views.administrator.administrator_lists import VaccinatorsList,PatientsList,YellowFeverList
